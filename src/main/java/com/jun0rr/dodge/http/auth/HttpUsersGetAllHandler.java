 ...
 * @author F6036477
 */
public class HttpUsersGetAllHandler implements Consumer<ChannelExchange<HttpRequest>> {
  
  public static final HttpRoute ROUTE = HttpRoute.of("/?auth/users/?", HttpMethod.GET);
  
  public static HttpUsersGetAllHandler get() {
    return new HttpUsersGetAllHandler();
  }
