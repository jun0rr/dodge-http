 ...
 * @author F6036477
 */
public class HttpGetAllRolesHandler implements Consumer<ChannelExchange<HttpRequest>> {
  
  public static final HttpRoute ROUTE = HttpRoute.of("\\/?auth\\/roles\\/?", HttpMethod.GET);
  
  public static HttpGetAllRolesHandler get() {
    return new HttpGetAllRolesHandler();
  }
