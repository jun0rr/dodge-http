 ...
 * @author F6036477
 */
public class HttpGroupsGetAllHandler implements Consumer<ChannelExchange<HttpRequest>> {
  
  public static final HttpRoute ROUTE = HttpRoute.of("/?auth/groups/?", HttpMethod.GET);
  
  public static HttpGroupsGetAllHandler get() {
    return new HttpGroupsGetAllHandler();
  }
